 ...
 * @generated
 */
public class EcliballsSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EcliballsPackage.BOARD: {
				Board board = (Board)theEObject;
				T result = caseBoard(board);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EcliballsPackage.FIELD: {
				Field field = (Field)theEObject;
				T result = caseField(field);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EcliballsPackage.FIGURE_LIST: {
				FigureList figureList = (FigureList)theEObject;
				T result = caseFigureList(figureList);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EcliballsPackage.FIGURE: {
				Figure figure = (Figure)theEObject;
				T result = caseFigure(figure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EcliballsPackage.SCORE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Figure List</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Figure List</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFigureList(FigureList object) {
		return null;
	}
